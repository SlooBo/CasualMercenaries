...
USTRUCT()
struct CASUALMERCENARIES_API FWeaponStruct
{
	...
	FWeaponStruct(uint16 clipSize, float reloadTime, uint16 damage, float fireRate, ERANGE_TYPE range, uint32 buyPrice,
